...
import { ASE7_DATA } from '../data/mock';

interface ASE7PageProps {
  onBack: () => void;
}

export const ASE7Page = ({ onBack }: ASE7PageProps) => {
      ...
      <Card className="overflow-hidden" hover={false}>
        <div className="p-8 bg-blue-600 dark:bg-blue-700 text-white">
          <div className="flex items-center gap-3 mb-2">
            <span className="px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full text-xs font-bold uppercase tracking-wider">ASE 7</span>
          ...
          <h2 className="text-3xl font-bold">{ASE7_DATA.title}</h2>
          <p className="text-blue-100 dark:text-blue-200 mt-2">{ASE7_DATA.description}</p>
        </div>
